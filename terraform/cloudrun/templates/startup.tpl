...
ansible-playbook deploy-cloud-run.yml -e frontend_repo=${frontend_repo} -e backend_repo=${backend_repo}  -e neo4j_ip=${neo4j_ip} -e neo4j_password=${neo4j_password} -e gcp_project=${gcp_project}
